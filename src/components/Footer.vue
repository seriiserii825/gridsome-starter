  ...
  <footer class="main-footer">
        ...
        <div class="main-footer__info-wrap">
          <div class="main-footer__info-item">
            ...
            <div class="main-footer__contacts">
              ...
              <div class="main-footer__contacts__item"> Email.
                <a href="mailto:diber@diberbevande.it">diber@diberbevande.it</a>
              </div>
              <div class="main-footer__contacts__item">Tel.
                <a href="tel:+390438941681">+39 (0) 438 941681</a>
              </div>
              <div class="main-footer__contacts__item">
          ...
          <div class="main-footer__info-item">
            ...
            <div class="main-footer__partners">
              <a class="main-footer__partners-item" href="#">
                <img src="assets/i/partners/1.png" alt="">
              </a>
              <a class="main-footer__partners-item" href="#">
                <img src="assets/i/partners/2.png" alt="">
              </a>
              <a class="main-footer__partners-item" href="#">
                <img src="assets/i/partners/3.png" alt="">
              </a>
            </div>
          </div>
        </div>
        ...
        <div class="form">
          <form>
            ...
            <div class="form-group">
              ...
              <label
                  for="check">Cliccando su invia dichiari di aver preso visione e di accettare la nostra privacy policy
              </label>
            </div>
          </form>
        </div>
    ...
    <div class="copyright">
      <div class="copyright__item">
        <p>Rasera Gianni D.I. – Partita Iva: 03083120265.<br> Copyright (C) 2020. Tutti i diritti riservati.
          <a href="#">Privacy and Cookie policy.</a>
        </p>
      </div>
      <div class="copyright__item">
        <p>Diber Bevandel ha<br> scelto Altuofianco</p>
        <a href="#">
